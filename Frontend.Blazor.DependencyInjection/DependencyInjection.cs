...
using UCR.ECCI.IS.VRCampus.Frontend.Blazor.Infrastructure;
using UCR.ECCI.IS.VRCampus.Frontend.Blazor.Application;

namespace UCR.ECCI.IS.VRCampus.Frontend.Blazor.DependencyInjection;
