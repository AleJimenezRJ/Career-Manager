...
internal class SqlEnterpriseRepository : SqlWorkInformationRepository, IEnterpriseRepository
{
    /// <summary>
    ...
    /// langword="null"/>.</param>
    public SqlEnterpriseRepository(VRCampusDatabaseContext dbContext)
        : base(dbContext)
    {
    ...
    public new async Task<IEnumerable<Enterprise>> ListAllAsync()
    {
