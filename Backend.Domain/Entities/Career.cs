...
/// <summary>
/// Represents an academic career or program that a student can enroll in and graduate from.
/// Includes core descriptive and structural attributes such as name, duration, modality, and degree title.
/// </summary>
public class Career
{
    /// <summary>
    ...
    public Career(int careerInternalId, EntityName? name, Description? description, SemestersNumber? semestersNumber, Modality? modality, DegreeTitle? degreeTitle, IEnumerable<WorkInformation> workInformation, decimal scholarship, bool isSteam)
    {
