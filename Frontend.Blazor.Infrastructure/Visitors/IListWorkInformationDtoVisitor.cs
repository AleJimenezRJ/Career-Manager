...
public interface IListWorkInformationDtoVisitor<out TResult>
{
    ...
    /// </summary>
    /// <param name="dto">The enterprise DTO to be processed. Cannot be null.</param>
    /// <returns>A result of type <typeparamref name="TResult"/> based on the processing of the specified DTO.</returns>
