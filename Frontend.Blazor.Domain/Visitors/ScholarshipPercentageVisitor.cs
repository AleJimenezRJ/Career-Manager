...
public class ScholarshipPercentageVisitor : IWorkInformationVisitor
{
    ...
    /// </summary>
    public decimal BaseScholarship { get; private set; }
    ...
    public void Visit(WorkLife workLife)
    {
        ...
        {
            int total = (int)(workLife.AmountFemaleWorkers.Number + workLife.AmountMaleWorkers.Number)!;
            if (total > 0)
            {
