namespace UCR.ECCI.IS.VRCampus.Frontend.Blazor.Domain.ResultPattern;
...
public class Result
{
    ...
    /// </summary>
    /// <returns>A <see cref="Result"/> object with a failure state. The returned instance has  <see cref="Result.IsSuccess"/>
    /// set to <see langword="false"/> and no associated value or error message.</returns>
